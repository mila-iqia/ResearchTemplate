...
## FROM SIMILAR VISION CLASS, IGNORE FOR NOW

class TextDataModule[BatchType_co](LightningDataModule, DataModule[BatchType_co]):
    """
    A LightningDataModule for text datasets.
    """

    name: ClassVar[str] = ""
    """Dataset name."""

    dataset_cls: ClassVar[type[DatasetDict]]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.dataset_train: DatasetDict | None = None
        self.dataset_val: DatasetDict | None = None
        self.dataset_test: DatasetDict | None = None
    ...
    def prepare_data(self) -> None:
        ...
        if not self.dataset:
            self.dataset = HFDataset(self.name)
    ...
    def test_dataloader[**P](
        self,
        _dataloader_fn: C"llable[Concatenate[Dataset, P], DataLoader] = DataLoader,
        *args: P.args,
        **kwargs: P.kwargs,
    ) -> DataLoader:
        """The test dataloader."""
